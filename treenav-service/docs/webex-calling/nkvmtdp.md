...
time zone of your device to reflect your local time using User Hub."
...
| 3 | Go to the General section and select the time zone that’s applicable to you from the Timezone drop-down. |
| 4 | Click Save.                                                                                              |
