---
title: "Use Webex Go on your mobile phone"
product: "Webex Calling"
article_id: "fqdvwd"
url: "https://help.webex.com/en-us/article/fqdvwd/Known-Issues-and-Limitations-for-Webex-Go"
last_updated: "2025-11-26"
description: "Activate and use Webex Go effectively, access all essential configuration
settings and clear procedures for seamless mobile business communication."
tags: ["webex-calling", "webex-go"]
source: "help.webex.com"
---

# Use Webex Go on your mobile phone
...
2. Enter the digits you want to dial.
3. Press Send.
...
- If you decline the call on your **MPP phone**, your other devices continue to ring based on the device policy configuration. For information on how to decline a ringing call on all devices, see [Decline a Ringing Call on All Devices for a User](https://help.webex.com/article/vwydeq/Decline-a-ringing-call-on-all-devices-for-a-user).
...
By default, your Webex Go device overrides the **Do Not Disturb (DND)** status. It alerts you even when **DND**is enabled, unless you explicitly configure it not to alert. To enable or disable the Webex Go DND override, see [Configure Do Not Disturb (DND) override for Webex Go calls](https://help.webex.com/en-us/article/eh5qre/Configure-Do-Not-Disturb-%28DND%29-override-for-Webex-Go-calls).
...
- Webex feature codes: Use the built-in keypad to dial the applicable Webex Calling feature access codes. For a list of codes, see [Feature access codes for Webex Calling](https://help.webex.com/article/0zgzwj/Feature-access-codes-for-Webex-Calling).
...
1. On your iPhone, tap Settings \> Notifications.
2. Scroll, then tap Webex.
3. Turn on Time-sensitive notification.
4. Tap Banner Style, then tap Persistent.
...
1. On your Android device, go to Settings \> Notifications \> App Notifications.
2. Scroll, then tap Webex.
...
1. Settings \> Calling \> Calling Mode \> My Mobile Operator
...
2. Settings \> Calling \> Webex Call Overlay (Android only)  
...
3. Settings \> Notifications \> Calling \> Webex Call Management Notification  
...
1. During the call, tap Transfer.
2. Enter the person's name or number.
3. On entering the name or number, Tap Transfer. You will be disconnected, and the call transfers to the person you selected. The Webex app provides a confirmation that the call was transferred.

### Make a Consultative Transfer in the Webex App

1. During the call, tap Transfer.
2. Enter or select the person's name or number, then tap Consult.
3. The Webex App puts the original call on hold and places a second call to the person you selected.
4. After consultation, tap Transfer. You will be disconnected, and the call transfers to the person you selected. The Webex App provides a confirmation that the call was transferred.
...
1. On your Webex Go device, open the built-in dialer.
2. Dial \*11\.
...
To move an active call from your Webex Go device to another device, see [Webex App | Pull a call from one device to another](https://help.webex.com/article/g9f3yo/Webex-App-%7C-Pull-a-call-from-one-device-to-another#id%5F135531).
...
1. During the call, tap the Webex App banner.
2. Tap Video Meeting.
3. When you’re notified that a participant is waiting in the lobby, tap Let in.

Elevate an audio call to a Webex video meeting (Android)

1. During the call, tap the Webex App banner or tap the Webex icon.
2. Tap More \> Video Meeting
3. When you’re notified that a participant is waiting in the lobby, tap Let in.
...
1. During the call, tap the Webex App banner.
2. The active call window opens and your call connects to the meeting.

### Change your CLID for subsequent calls

If your administrator enables user-level caller ID options, you can change your caller ID in the Webex app on desktop. Changing caller ID for Webex Go users is not available in the mobile app. See [Change your caller ID in the Webex app](https://help.webex.com/article/e43k9e/Webex-App-%7C-Change-your-caller-ID).

### On-demand call recording

If your administrator enabled on-demand call recording, use your Webex Go device’s built-in dialer to enter the Webex Calling feature access codes. For the full list, see [Feature access codes for Webex Calling](https://help.webex.com/article/0zgzwj/Feature-access-codes-for-Webex-Calling).

### Record a call on your Webex Go device

Record a call in the Webex app. For steps, see [Record your phone calls in the Webex App](https://help.webex.com/article/nuu13a1/Webex-App-%7C-Record-your-phone-calls#Cisco%5FTask%5Fin%5FList%5FGUI.dita%5F57b4244c-4b36-4cdc-af08-cfa5a9406990).
