---
title: "Access Dedicated Instance Applications from Control Hub"
product: "Dedicated Instance"
article_id: "n2hzeox"
url: "https://help.webex.com/en-us/article/n2hzeox/Access-Dedicated-Instance-Applications-from-Control-Hub"
last_updated: "2025-09-08"
description: "Access the Dedicated Instance Applications from Control Hub allows you to launch
and manage UCM applications seamlessly. You can cross-launch these applications
from Control Hub and selecting the desired UC applications."
...
The browser used for cross launching the above Unified Communication applications from Control Hub should be enabled to allow cookies. For further troubleshooting tips, refer to [Troubleshooting Cross Launch Issues](#troubleshoot%5Fcrosslaunch) section.

1. Sign in to Control Hub at <https://admin.webex.com/login>
2. Go to Services \> Calling \> Dedicated Instance \> Manage.
3. Select the UC Application and click Manage on the right pane to launch the corresponding UC application or the Expressway portal. The Unified Communication application’s built-in portal is cross launched in a new tab.
...
1. Supported Browsers:  
  ...
  - Microsoft Edge
  - Safari
2. Procedure to clear the web browser cache and cookies:
  ...
  - In case you have **HTTP status code: 401** while cross launching the UC application from Mozilla FireFox, perform the following settings:
    ...
    1. Click the Menu icon in the upper-right of the browser window.
    2. Click Settings \> Privacy & Securtiy.
    3. Select Custom radio button and select Cookies and Tracking content check box.
    4. Reload the browser.
  - [How Do I Clear Cache and Cookies in Google Chrome?](https://help.webex.com/WBX38899/Clear-Cache-and-Cookies-in-Google-Chrome)
  - [How Do I Clear Cache and Cookies in Microsoft Edge](https://help.webex.com/WBX9000035442)
  - To clear cookies in Safari browser:
    1. Open the Safari app.
    2. Click the Safari menu in the top-left corner of your screen.
    3. Select Settings.
    4. Click the Privacy tab.
    5. Click Manage Website Data.
    6. To remove all website data, click Remove All.
    7. Confirm by clicking Remove Now, then Done.
3. If the above options does not resolve the issue, please contact [TAC](https://help.webex.com/en-US/article/WBX42698/How-Do-I-Contact-Cisco-Technical-Assistance-Center-%28TAC%29) for further assistance.
...
Configuring an email group to receive WebRTMT alerts is not supported in DI. Instead, you can set up a delivery channel through Control Hub to receive notifications via email and/or Webex space. Refer to [Alerts center in Control Hub](https://help.webex.com/mykour#%5F49143318-fe04-4b19-8d3e-5133880e4a3d) and [Control Hub application status alarm definitions](https://help.webex.com/lc58fab) for more information on setting up the delivery channel and the alerts notified to Control Hub.

The cross launch is Over-The-Top (OTT) and does not require VPN access.

**Before you begin** 

The browser used to access the Control Hub should allow cookies for the site - _https://apps.ucmgmt.cisco.com_.
...
For more information about the previously mentioned alerts, refer to [ _Cisco Unified Real-Time Monitoring Tool Administration Guide_](https://www.cisco.com/c/en/us/td/docs/voice%5Fip%5Fcomm/cucm/service/12%5F5%5F1SU4/rtmt/cucm%5Fb%5Fcisco-unified-real-time-monitoring-1251su4.html) for your respective Unified CM release.
...
| Ports in Service | This card displays a trend chart of the ports in service of the selected gateway type, which are actively registered with each call processing node of the selected cluster.                                                                                                                                     |
...
See [Borderless CTI](https://help.webex.com/6yojgab) for more information.
