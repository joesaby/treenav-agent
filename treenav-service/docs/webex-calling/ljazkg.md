---
title: "Configure single sign-on in Control Hub with F5 Big-IP"
product: "Webex Calling"
article_id: "ljazkg"
url: "https://help.webex.com/en-us/article/ljazkg/Configure-single-sign-on-in-Control-Hub-with-F5-Big-IP"
last_updated: "2025-10-21"
description: "You can configure a single sign-on (SSO) integration between Control Hub and a
deployment that uses F5 Big-IP as an identity provider (IdP)."
...
| 3  | Enter a meaningful name for the service provider name, such as **<yourorganizationname>.ciscowebex.com**.                              |
| 4  | Under **Security Settings**, check the following checkboxes: **Response must be signed** **Assertion must be signed**                  |
...
| - | ------------------------------------------------------------------------------------- |
| 2 | Ensure that the **Sign Metadata** value is **Yes**.                                   |
...
| 9 | For **Select Ending**, select **Allow**. The access policy should look like this screenshot: ![](https://cisco-api.ingeniuxondemand.com/DITA/content/en/us/td/i/400001-500000/410001-420000/414001-415000/414978.jpg) |
