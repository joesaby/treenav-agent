---
title: "Webex Calling for Chrome | Release Notes"
product: "Webex Calling"
article_id: "93xxk2"
url: "https://help.webex.com/en-us/article/93xxk2/Webex-Calling-for-Chrome-Release-Notes"
last_updated: "2024-08-30"
description: "These Release Notes contain up to date information for the Webex Calling for
Chrome extension. Refer to this document for the latest support information."
tags: ["webex-calling"]
...
Webex Calling for Chrome is available as an extension in the Google Chrome Web Store. Webex Calling for Chrome delivers a powerful suite of enterprise calling features through an intuitive, browser-based softphone. For more information, see [Webex Calling for Chrome](https://help.webex.com/a5ormz/).

## Prerequisites

Webex Calling for Chrome is available to all Webex Calling users with a [Professional license](https://help.webex.com/nvzzj7k/). Visit [Chrome Webstore](https://chrome.google.com/webstore/) and search for Webex Calling for Chrome to add it as an extension into your Chrome and Edge Chromium browser. The extension works on desktop operating systems that support Chrome and Edge Chromium. The following Operating Systems are supported: 
