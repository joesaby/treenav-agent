...
All Webex App users can browse through the available list in the [Webex App Hub](https://apphub.webex.com/) and choose a bot or an integration. The bots and integrations are grouped into categories, for example, customer relations, developer tools.

You don't need to know coding or use APIs to use bots or integrations. But if you want to build your own, see [ developer.webex.com](http://developer.webex.com) to learn how.
...
If you're having issues with an integration or bot, please reach out to the company who created it. You can find the company name below the bot or integration name in the [Webex App Hub](https://apphub.webex.com). If you notice anything urgent, please report issues to [devsupport@webex.com](mailto:devsupport@webex.com). Cisco reviews every integration and bot listed in the Webex App Hub.
...
| 1 | Go to [Webex App Hub](https://apphub.webex.com) and click Log in using your Webex App user name and password. Click your profile picture and select My Webex Integrations to see your current integrations.                                                                                                                                                                                                                                                                                  |
| - | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2 | Click **Webex App**.                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 3 | Click the icon of the integration or bot you want to add or connect to: To add an integration click Connect.Some integrations may have unique requirements, review the details in Webex App Hub.To add a bot click Add to Space. The spaces listed are spaces with two or more people or team spaces. However, you can start a conversation directly with the bot, create a space and add the bot using the bot name and _@webex.bot_. For example, add the Help bot using _help@webex.bot_. |
| 4 | Follow the prompts to add your bot or integration to a space in Webex App.                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| 1 | Sign into [Webex App Hub](https://apphub.webex.com) using your Webex App user name and password.                                                        |
| - | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2 | Click your profile picture and select My Webex Integrations to see a list of all the integrations you have added.                                       |
| 3 | Select the integration you want to remove and click Disconnect. The integration is removed from all spaces and the access permissions are disconnected. |
