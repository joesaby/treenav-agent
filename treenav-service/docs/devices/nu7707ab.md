...
product: "Devices"
article_id: "nu7707ab"
url: "https://help.webex.com/en-us/article/nu7707ab/Configure-a-Static-IP-Address"
last_updated: "2024-09-14"
description: "Configure a Static IP Address"
tags: ["devices"]
...
| 1 | In your web browser, enter the IP address to access the device page. You may have to add and confirm a security exception for the web page. |
| - | ------------------------------------------------------------------------------------------------------------------------------------------- |
| 2 | Click Setup \> Edit.                                                                                                                        |
| 3 | Enter your new IP address in one of the available fields.                                                                                   |
| 4 | Click Save. The new IP address loads in your browser.                                                                                       |
