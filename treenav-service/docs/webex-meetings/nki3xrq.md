---
title: "Webex Meetings Suite System Requirements"
product: "Webex Meetings"
article_id: "nki3xrq"
url: "https://help.webex.com/en-us/article/nki3xrq/Webex-Meetings-Suite-System-Requirements"
last_updated: "2025-10-21"
description: "Here&#x27;s what you need to know about the requirements to join and host meetings.
We&#x27;ve put together information about minimum browser and OS requirements,
supported email applications, and supported languages."
...
See the [Web App Supported Operating Systems and Browsers](https://help.webex.com/9ehuwu/) for more information on the additional features for Linux that are available in the Webex Meetings desktop app. 
...
See the [Web App Supported Operating Systems and Browsers](https://help.webex.com/9ehuwu/) for more details on what's supported.

The Webex Meetings mobile app (version 11.0 or higher) is [supported on all Chrome devices that officially support Android apps](https://www.chromium.org/chromium-os/chrome-os-systems-supporting-android-apps), through Google Play.
...
See the [Web App Supported Operating Systems and Browsers](https://help.webex.com/9ehuwu/) for more information on the additional features for Linux that are available in the Webex Meetings Web App.
...
- [Get started with the Webex Meetings web app](https://help.webex.com/article/9eed9t/Get-started-with-the-Webex-Meetings-web-app)
- [Webex Meetings web app meeting functionality](https://help.webex.com/article/nt8cif7/Webex-Meetings-web-app-meeting-functionality)
- [Webex Meetings and Webex Webinars accessibility features](https://help.webex.com/article/84har3/Webex-Meetings-and-Webex-Events-accessibility-features)
- [Webex Meetings web app known issues and limitations](https://help.webex.com/article/n0rqd8g/Webex-Meetings-web-app-known-issues-and-limitations)
