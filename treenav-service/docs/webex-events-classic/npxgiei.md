---
title: "Conduct a Practice Session in Webex Events (classic)"
product: "Webex Events (Classic)"
article_id: "npxgiei"
url: "https://help.webex.com/en-us/article/npxgiei/Conduct-a-Practice-Session-in-Cisco-Webex-Events-Classic"
last_updated: "2024-09-16"
description: "Conduct a Practice Session in Webex Events (classic)"
tags: ["webex-events-(classic)"]
source: "help.webex.com"
---

# Conduct a Practice Session in Webex Events (classic)

## About Practice Sessions

Practice sessions allow the host, presenter, and other panelists to practice an event before starting it. They're similar to a dress rehearsal—An event production team can perform all event functions without event attendees viewing the event. 
