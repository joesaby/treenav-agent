...
Manager, Expressway-C configuration, and Expressway-E configuration."
tags: ["edge-audio"]
...
If you manage your Webex sites in Webex Site Administration, or have completed the [Site Linking process](https://help.webex.com/en-us/article/341eud), then use these steps. Configure the dial-in settings, collect the full list of dial-in numbers, and export a copy of the Lua script.
...
| Step | Description                                                                     | Section                                                                                                                          |
| ---- | ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| 1    | Create a neighbor zone to your Unified CM on the Expressway-C.                  | [Create Neighbor Zone to Unified CM for Expressway-CExpressway-E](#Cisco%5FTask.dita%5Fd4837499-82e9-4685-8414-0afc9606c043)     |
| 2    | Define a secure traversal client zone to your Expressway-E on the Expressway-C. | [Define Secure Traversal Client Zone to Expressway-E on Expressway-C](#Cisco%5FTask.dita%5Fe357ca2a-85d4-4b42-8ee3-8f549aac10d7) |
| 3    | Define search rules on the Expressway-C.                                        | [Define Search Rules on Expressway-C](#Cisco%5FTask.dita%5F86211844-89a9-48e0-8529-80a25b2fda35)                                 |

### Create Neighbor Zone to Unified CM for Expressway-CExpressway-E

| 1 | Sign in to the Expressway-CExpressway-E configuration page and go to Configuration \> Zones \> Zones, and select Add New.                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| - | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2 | Name the zone.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 3 | For Type, select Neighbor.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 4 | Under H.323, set the Mode to Off.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 5 | Under SIP, set these properties: Property Value Mode On Port Enter the same port number that you used for your SIP Trunk Secure Profile. Transport Select TLS if you're creating a secure neighbor zone, or TCP if you're creating an unsecure neighbor zone. You can only use one secure TLS trunk between Unified CM and Expressway. For more information, see [Intermittent calls to Destination fails via TLS trunk](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCus63305). If another TLS trunk exists, then you must configure a TCP trunk with Expressway here. Media encryption mode Auto |
| 6 | Under Location, enter the Unified CM peer information.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 7 | Under Advanced, set these properties: Property Value Zone Profile Custom SIP parameter preservation On                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 8 | Click Create Zone.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |

### Define Secure Traversal Client Zone to Expressway-E on Expressway-C

| 1 | Sign in to the Expressway-C configuration page, go to Configuration \> Zones \> Zones, and then select Add New.                                                                                                                                                                                                                                                         |
| - | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2 | Name the zone.                                                                                                                                                                                                                                                                                                                                                          |
| 3 | For Type, select Traversal client.                                                                                                                                                                                                                                                                                                                                      |
| 4 | Under Connection Credentials, enter the username and password that's used to connect to the traversal server.                                                                                                                                                                                                                                                           |
| 5 | Under H.323, set the Mode to Off.                                                                                                                                                                                                                                                                                                                                       |
| 6 | Under SIP, set these properties: Property Value Port Enter the port number. Transport TLS Media encryption mode Force encrypted This setting ensures that the media traffic flowing between the customer edge and Webex is secure. SIP parameter preservation On This setting ensures the right parameters that the Lua script sets up are passed through Expressway-C. |
| 7 | Under Location, enter the IP address for your Expressway-E. If there is more than one IP address, enter them all.                                                                                                                                                                                                                                                       |
| 8 | Save your zone.                                                                                                                                                                                                                                                                                                                                                         |

### Define Search Rules on Expressway-C

| 1 | Sign in to the Expressway-C configuration page, go to Configuration \> Dial plan \> Search rules, and select New.                                                                                                                                                                     |
| - | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2 | Name the search rule and assign it a priority, if necessary.                                                                                                                                                                                                                          |
| 3 | Set these properties: Property Value Protocol SIP Mode Alias pattern match Pattern type Regex Pattern string Enter this exact regular expression: .+@.+\\.webex\\.com(;.+)? Pattern behavior Leave On successful match Stop Target Select the traversal client zone that you created. |
...
| Step | Description                                                 | Section                                                                                                          |
| ---- | ----------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| 1    | Define a secure traversal server zone on your Expressway-E. | [Define Secure Traversal Server Zone on Expressway-E](#Cisco%5FTask.dita%5F49df14a9-77d0-4daf-87a6-db4bc477bae8) |
| 2    | Define the Webex zone on your Expressway-E.                 | [Define the Webex Zone on Expressway-E](#Cisco%5FTask.dita%5F3a2d3d1b-59f3-44ea-b53d-9db656d595a0)               |
| 3    | Define search rules on your Expressway-E.                   | [Define Search Rules on Expressway-E](#Cisco%5FTask.dita%5F4690572b-c8a3-438f-8caf-15356cd95406)                 |
| 4    | Set up your Expressway-E to use TLS v1.2.                   | [Set Up Expressway-E for TLS v1.2](#Cisco%5FTask.dita%5Fa45c251d-47d7-40d6-8a83-484e90b87edd)                    |
| 5    | Set up mTLS on your Expressway-E.                           | [Set Up Mutual TLS on Expressway-E](#Cisco%5FTask.dita%5F6cd78a88-001c-4d7a-abb1-701a4e22f0d8)                   |
| 6    | Update the minimum session timer of your Expressway-E.      | [Update the Minimum Session Timer](#Cisco%5FTask.dita%5F2edb3d6c-ae58-4a8b-9584-c3c847a4a1f8)                    |
...
| ---- | ----------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| 1    | Define a secure traversal server zone on your Expressway-E.       | [Define Secure Traversal Server Zone on Expressway-E](#Cisco%5FTask.dita%5F49df14a9-77d0-4daf-87a6-db4bc477bae8) |
| 2    | Define the DNS zones with Mutual TLS (mTLS) on your Expressway-E. | [Define DNS Zones with Mutual TLS on Expressway-E](#Cisco%5FTask.dita%5Fd7b34f53-4c14-4173-9bb1-4310005ffad5)    |
| 3    | Define search rules on your Expressway-E.                         | [Define Search Rules on Expressway-E](#Cisco%5FTask.dita%5F4690572b-c8a3-438f-8caf-15356cd95406)                 |
| 4    | Set up your Expressway-E to use TLS v1.2.                         | [Set Up Expressway-E for TLS v1.2](#Cisco%5FTask.dita%5Fa45c251d-47d7-40d6-8a83-484e90b87edd)                    |
| 5    | Set up mTLS on your Expressway-E.                                 | [Set Up Mutual TLS on Expressway-E](#Cisco%5FTask.dita%5F6cd78a88-001c-4d7a-abb1-701a4e22f0d8)                   |
| 6    | Update the minimum session timer of your Expressway-E.            | [Update the Minimum Session Timer](#Cisco%5FTask.dita%5F2edb3d6c-ae58-4a8b-9584-c3c847a4a1f8)                    |
...
| 1 | Sign in to the Expressway-E configuration page, go to Configuration \> Zones \> Zones, and select New.   |
| - | -------------------------------------------------------------------------------------------------------- |
| 2 | Name the zone.                                                                                           |
| 3 | For Type, choose Traversal Serverand select Create zone.                                                 |
| 4 | Enter the username and password that you configured in the Traversal Client Zone of your Expressway-C.   |
| 5 | Under H.323, set the Mode to Off.                                                                        |
| 6 | Under SIP, set these properties: Property Value Media encryption mode Auto SIP parameter preservation On |
| 7 | Save the zone.                                                                                           |
...
| 1 | Sign in to the Expressway-E configuration page, go to Configuration \> Zones \> Zones, and select New.                                                                                                                                        |
| - | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2 | For Type, select Webex.                                                                                                                                                                                                                       |
| 3 | Click Create zone.                                                                                                                                                                                                                            |
| 4 | Find the numeric zone ID for the Webex zone by selecting it from the zone list. The numeric zone ID appears in your browser address bar, for example, "editzone?id=3".                                                                        |
| 5 | Using the admin CLI with numeric zone ID, set the Webex Zone to use a Force Encrypted media encryption configuration. For example, if the zone ID is 3, you use this command: xConfiguration Zones Zone 3 DNS SIP Media Encryption Mode: "On" |
...
| 1  | Sign in to the Expressway-E configuration page, go to Configuration \> Zones \> Zones, and select Create Zone.                                         |
| -- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2  | Name the zone.                                                                                                                                         |
| 3  | For Type, select DNS.                                                                                                                                  |
| 4  | Under H.323, set the Mode to Off.                                                                                                                      |
| 5  | For TLS verify mode, select On.                                                                                                                        |
| 6  | For TLS verify subject name, enter sip.webex.com.                                                                                                      |
| 7  | For TLS verify inbound mapping, select On.                                                                                                             |
| 8  | Set the Media encryption mode to Auto.                                                                                                                 |
| 9  | Set the Media encryption mode to Force Encrypted.                                                                                                      |
| 10 | Under Advanced, set Zone profileto Custom.                                                                                                             |
| 11 | For SIP parameter preservation, select On. This setting ensures that the right parameters that the Lua script sets up are passed through Expressway-E. |
| 12 | Save your changes.                                                                                                                                     |

### Define Search Rules on Expressway-E

| 1 | Sign in to the Expressway-E configuration page, go to Configuration \> Dial plan \> Search rules, and select New.                                                                                                                                                                                                  |
| - | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2 | Name the search rule and assign it a priority, if necessary.                                                                                                                                                                                                                                                       |
| 3 | Set these properties: Property Value Protocol SIP Mode Alias pattern match Pattern type Regex Pattern string Enter this exact regular expression: .+@.+\\.webex\\.com(;.+)? Pattern behavior Leave On successful match Stop Target Webex Zone (for version X8.11 and later). DNS Zone (for versions before X8.11). |
| 4 | Click Create search rule.                                                                                                                                                                                                                                                                                          |
...
| 1 | Sign in to the Expressway-E configuration page and go to Maintenance \> Security \> Ciphers.                |
| - | ----------------------------------------------------------------------------------------------------------- |
| 2 | For SIP TLS ciphers, enter this cipher: EECDH:EDH:HIGH:-AES256+SHA:!MEDIUM:!LOW:!3DES:!MD5:!PSK:!eNULL:+ADH |
| 3 | For SIP minimum TLS version, select TLS v1.2.                                                               |
| 4 | Save your changes.                                                                                          |
...
| 1 | Sign in to the Expressway-E configuration page and go to Configuration \> Protocols \> SIP. |
| - | ------------------------------------------------------------------------------------------- |
| 2 | For Mutual TLS mode, select On.                                                             |
| 3 | Set the Mutual TLS port to 5062.                                                            |
| 4 | Save your changes.                                                                          |
...
| 1 | Sign in to the Expressway-E configuration page and go to Configuration \> Protocols \> SIP. |
| - | ------------------------------------------------------------------------------------------- |
| 2 | Scroll to Session refresh interval (seconds), and set the value to 14400.                   |
| 3 | Save your change.                                                                           |
...
After you complete the Unified CM and ExpresswayCUBE configurations, you must open the necessary firewall ports. Refer to this article, <https://help.webex.com/article/WBX264>, for network requirement information and which ports to open.

### Signed Certificates from a Trusted Certificate Authority

Edge Audio requires your Expressway-E to offer signed certificates from trusted CA certificate authorities for Mutual TLS (mTLS) connections. This article lists the certificate authorities that Cisco trusts: <https://help.webex.com/article/WBX9000008850>. Edge Audio considers certificates that listed authorities sign as valid and allows the connection. 

If you use your Expressway-E for Webex for Government, you must enable mTLS.

Edge Audio requires your CUBE to offer signed certificates from trusted CA certificate authorities for Mutual TLS (mTLS) connections. Use the following link to get to a list of certificate authorities that Cisco trusts: <https://help.webex.com/article/WBX9000008850>. Edge Audio considers certificates that listed authorities sign as valid and allows the connection. 
...
| 1 | Sign in to the Expressway-E configuration page and go to Maintenance \> Security \> Trusted CA certificate. |
| - | ----------------------------------------------------------------------------------------------------------- |
| 2 | Under Upload, select Browse and upload the PEM files that you created.                                      |
| 3 | Click Append CA certificate.                                                                                |
...
| 1 | Sign in to the Expressway-C configuration page, go to Configuration \> Dial Plan \> Search rules, and select New.                                                                                                                                                                                                                                                                                             |
| - | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2 | Name the rule and assign it a priority, if necessary.                                                                                                                                                                                                                                                                                                                                                         |
| 3 | Set these properties: Property Value Protocol SIP SIP variant All SIP Variants Source Named Source name Select the Traversal Client Zone that you created for Edge Audio. Mode Alias pattern match Pattern type Regex Pattern string Enter this exact regular expression: .\*@.\* Pattern behavior Leave On successful match Stop Target Select the Unified CM neighbor zone that you created for Edge Audio. |
| 4 | Select Create search rule.                                                                                                                                                                                                                                                                                                                                                                                    |
...
| - | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2 | Name the rule and assign it a priority, if necessary.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 3 | Set these properties: Property Value Protocol SIP SIP variant All SIP Variants Source Named Source name Select the DNS Zone or Webex Zone that you configured for Edge Audio. Mode Alias pattern match Pattern type Regex Pattern string Enter this exact regular expression: (.\*)@.\*;x-cisco-webex-service=audio Pattern behavior Replace Relace string Enter \\1@customerdomain.com. Unified CM must expect the value “customerdomain.com” for incoming calls based on the Clusterwide Domain Configuration. To verify the Clusterwide Domain Configuration configuration, go to System \> Enterprise Parameters, and scroll to Clusterwide Domain Configuration. On successful match Stop Target Select the traversal server zone you created for Edge Audio. Select the neighbor zone you created for Edge Audio. |
| 4 | Select Create search rule.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
If you manage your Webex sites in Webex Site Administration, or have completed the [Site Linking process](https://help.webex.com/article/341eud), then enable extension callback in Webex Site Administration.
...
If you manage your Webex sites in Webex Site Administration, or have completed the [Site Linking process](https://help.webex.com/article/341eud), use these steps to specify the countries or regions to which Webex can route callbacks.
...
| 1 | Export or copy the CPL XML file of your Webex site: For sites managed in Cisco Webex Site Administration, sign in to Webex Site Administration and go to Configuration \> Common Site Settings \> Audio Settings. For sites managed in Cisco Webex Control Hub, from the customer view in [https://admin.webex.com](https://admin.webex.com/), go to Services, and under Meeting, select Sites. Choose the Webex site for which to view the CPL XML file, and go to Configure Site \> Common Settings \> Audio Settings. |
| - | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2 | In the Edge Audio Customer Edge section, click Secure Edge.                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 3 | In the Expressway-E section, click Export or Copy. If you have more than one Webex site that goes through a single Expressway-E, then repeat steps 1-3 for each Webex site. For each additional Webex site, copy the <taa:rule> block that contains the site UUID into one file.                                                                                                                                                                                                                                         |
| 4 | Sign in to the Expressway-E configuration page, and go to Configuration \> Call Policy.                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 5 | For Select the new Call Policy file, select Choose File and upload the CPL XML file.                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 6 | Click Show Call Policy File to check your uploaded file.                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| 6 | In the Call Routing drop-down list, select Webex Calling On-net Routing. ![Edge Audio Allowed Callback Numbers page displaying options with the Call Routing drop-down list expanded and Webex Calling On-net Routing as the selected option.](https://cisco-api.ingeniuxondemand.com/DITA/content/en/us/td/i/400001-500000/460001-470000/468001-469000/468154.jpg) |
