---
title: "Configure Cisco Webex Support in Cisco Webex Control Hub"
product: "Webex Support"
article_id: "ny8v975"
url: "https://help.webex.com/en-us/article/ny8v975/Configure-Cisco-Webex-Support-in-Cisco-Webex-Control-Hub"
last_updated: "2024-09-15"
description: "Webex site administrators can set up Webex Support options and preferences for
their support representatives and sessions."
tags: ["webex-support", "webex-meetings", "webex-webinars"]
source: "help.webex.com"
---

# Configure Cisco Webex Support in Cisco Webex Control Hub
...
| 3 | Under Webex Support, select CSR Preferences.                                                                                         |
| 4 | In the CSR Preferences section, select one of the following: ActiveX Java client Temporary Folder Solution (TFS)                     |
| 5 | To enable a standalone client with ActiveX, check the Standalone client check box.                                                   |
| 6 | Click Update.                                                                                                                        |
...
| 2 | Choose the Webex site to change the settings for, and click Configure Site.                                                          |
| 3 | Under Webex Support, select CSR Preferences.                                                                                         |
| 4 | In the Customer Preferences section, select Allow customers to join a session by selecting from a list of available agents.          |
| 5 | Indicate whether agents are listed by their first or by their full names.                                                            |
| 6 | Click Update.                                                                                                                        |
...
| 2 | Choose the Webex site to change the settings for, and click Configure Site.                                                          |
| 3 | Under Webex Support, select CSR Preferences.                                                                                         |
| 4 | In the Customer Preferences section, check the Allow customer to send webcam video feed check box.                                   |
...
| - | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2 | Choose the Webex site to change the settings for, and click Configure Site.                                                                                                             |
| 3 | Under Webex Support, select Branding.                                                                                                                                                   |
| 4 | Select Create New Style, and then enter a name for this new style. Enter up to 40 characters, and do not use any of the following characters in the name: % # ^ { } / \\ \* ? : \| " @. |
| 5 | Select the Images tab to change the images that appear on the window.                                                                                                                   |
| 6 | Select the Header tab to change the header.                                                                                                                                             |
| 7 | Select the Messages tab and change the text in the Text Message box to change the status messages that appear in the dashboard.                                                         |
| 8 | Select the Fonts & Colors tab to change the fonts and colors used.                                                                                                                      |
| 9 | Click Preview to see the results, and then click Save.                                                                                                                                  |
...
| 3 | Under Webex Support, select CSR Preferences.                                                                                                                                                                                                                                                                                                                                                                                                     |
| 4 | In the CSR Preferences section, select the CSR Dash Customization link.                                                                                                                                                                                                                                                                                                                                                                          |
| 5 | To specify content sharing, select from the following: Document sharing: Check this check to share documents and presentations. Checking this option unchecks the "Remote printing" option. The default value is enabled. Remote printing: Check this check box to print documentation from the user's computer to the site administrator's printer. Checking this option unchecks the "Document sharing" option. The default value is disabled. |
| 6 | Click Save.                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| 2 | Choose the Webex site to change the settings for, and click Configure Site.                                                          |
| 3 | Under Webex Support, select CSR Preferences.                                                                                         |
| 4 | Under CSR Preferences, select the CSR Dash Customization link.                                                                       |
| 5 | Check Enforce recording automatically when meeting starts to automatically begin recording when a meeting begins.                    |
| 6 | Select Network-based recording (NBR) or Save recording at local computer.                                                            |
| 7 | Specify the location to save session recordings.                                                                                     |
| 8 | Click Save.                                                                                                                          |
...
| 3 | Under Webex Support, select CSR Preferences.                                                                                         |
| 4 | Under CSR Preferences, select the CSR Dash Customization link.                                                                       |
| 5 | Check Allow chat contextual switching to replace the "All Participants" with the actual name of the participant receiving the chat.  |
| 6 | Click Save.                                                                                                                          |
...
| 2 | Choose the Webex site to change the settings for, and click Configure Site.                                                                                                 |
| 3 | Under Webex Support, select CSR Preferences.                                                                                                                                |
| 4 | In the CSR Preferences section, select CSR Dash Customization.                                                                                                              |
| 5 | In the Features section, select Alert the agent if the support session is idle for more than, and then enter the number of minutes to wait before ending the session.       |
| 6 | To have the session end if the CSR doesn’t respond, select Automatically end session if agent doesn’t respond to alert after, and then enter the number of minutes to wait. |
| 7 | Click Save.                                                                                                                                                                 |
...
| 1 | From the customer view in [https://admin.webex.com](https://admin.webex.com/login), go to Services, and under Meeting, select Sites.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| - | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2 | Choose the Webex site to change the settings for, and select Configure Site.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 3 | Under Webex Support, select CSR Preferences.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 4 | In the CSR Preferences section, select CSR Dash Customization.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 5 | In the Instructions section, select Custom instructions.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 6 | Select one of the following: Plain text: the instructions are not formatted. Up to 2000 characters can be entered. HTML: the instructions can be formatted to add numbered lists and bullets, align the text, add horizontal lines, backgrounds, and any formatting possible with HTML coding. Up to 4000 characters can be entered.  The default instructions include the variable %SessionID%, which Webex Support automatically replaces with the support session number. If this variable is removed from the message, users have to enter the session ID before they can join a session. Therefore, we recommend that this variable is included in the custom instructions. |
| 7 | Enter the instructions in the box.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 8 | Click Save.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
