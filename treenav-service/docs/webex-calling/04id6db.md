...
For , when the [E911 service](https://help.webex.com/en-US/article/av6oo3/RedSky-Emergency-911-Service-for-Webex-Calling) is configured, Webex App prompts the user to provide an emergency address when they connect to an unknown network. This address is used as the dispatch address when emergency calls are placed. When you are not using the E911 service capability, the registered address is used as the emergency address in the event of a 911 call.
